...
public class SensorHalService extends SensorHalServiceBase {
    ...
    private final static ManagerToHalPropIdMap mManagerToHalPropIdMap =
        ManagerToHalPropIdMap.create(
            ...
            CarSensorManager.SENSOR_TYPE_FUEL_LEVEL_LOW, VehicleProperty.FUEL_LEVEL_LOW,
            CarSensorManager.SENSOR_TYPE_CURRENT_GEAR, VehicleProperty.CURRENT_GEAR,
            CarSensorManager.SENSOR_TYPE_TURN_SIGNAL_STATE, VehicleProperty.TURN_SIGNAL_STATE,
            CarSensorManager.SENSOR_TYPE_ENGINE_OIL_TEMP, VehicleProperty.ENGINE_OIL_TEMP,
            CarSensorManager.SENSOR_TYPE_ENGINE_COOLANT_TEMP, VehicleProperty.ENGINE_COOLANT_TEMP,
